    ...
    <section className="text-white lg:px-24 px-0  body-font bg-backgroundColor">
      <div className="container  mx-auto">
        <div className="text-center py-20 bg-red-600">
          ...
          <button onClick={handleScheduleCall} className="flex mx-auto mt-8 text-black bg-white border-0 py-2 px-8 focus:outline-none  rounded text-lg">Schedule a Call</button>
        </div>
      </div>
    </section>
    </>
