...
const Footer = () => {
    ...
    return (
        <><header class="text-gray-600 body-font bg-backgroundColor ">
        ...
        <a key={index} href={link.href} target="_blank" rel="noopener noreferrer">
          <img className="w-6 mr-5 h-auto hover:opacity-75 transition-opacity" src={link.src} alt={link.alt} />
                ...
                <div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
                    <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Back To Top
