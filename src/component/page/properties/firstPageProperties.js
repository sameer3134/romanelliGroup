...
const FirstPageProperties = () => {
    ...
    return (
        ...
        <div className="relative z-10 container px-4 sm:px-5 py-12 md:py-24 mx-auto font-dmsans">
          ...
          <div className="flex flex-col text-center w-full mb-6">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-4 text-white mx-auto max-w-4xl px-4">
              Your{" "}
          ...
          <div className="flex justify-start items-center mx-auto  max-w-2xl">
            ...
            <button
              className={`p-2 px-4  text-white ${
                selectedOption === "Buy" ? "bg-gray-900" : "bg-gray-600"
              }`}
            ...
            <button
              className={`p-2 px-4  text-white ${
                selectedOption === "Rent" ? "bg-gray-900" : "bg-gray-600"
              }`}
  ...
  <div className='flex'>  Filter  <span className="ml-2 flex items-center">
